...
export default {
    ...
    created () {
        this.types =localStorage.getItem('select3')
        this.kayitli()
    },
    ...
    methods: {
        ...
        on_click(zaman,zaman2){
            ...
            var coins=localStorage.getItem('select3')
            ...
            localStorage.setItem('zaman3', time);
            localStorage.setItem('zaman32', time2);
        ...
        let now = Utils.now()    
        var ycoins=`binance-${coins}`
        let time=localStorage.getItem('zaman3');
        let time2=localStorage.getItem('zaman32');
        ...
        selectCategory(event) {           
            ...
            localStorage.setItem('select3', coins);
        },
