...
export default {
    ...
    created () {
        this.types =localStorage.getItem('select2')
        this.kayitli()
    },
    ...
    methods: {
        ...
        on_click(zaman,zaman2){
            ...
            var coins=localStorage.getItem('select2')
            ...
            localStorage.setItem('zaman2', time);
            localStorage.setItem('zaman22', time2);
        ...
        let now = Utils.now()    
        var ycoins=`binance-${coins}`
        let time=localStorage.getItem('zaman2');
        let time2=localStorage.getItem('zaman22');
        ...
        selectCategory(event) {           
            ...
            localStorage.setItem('select2', coins);
        },
